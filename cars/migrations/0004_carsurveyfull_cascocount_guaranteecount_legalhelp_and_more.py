...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cars', '0003_car_img_10_car_img_8_car_img_9'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_gai_record', models.BooleanField(default=True, verbose_name='Планируете ли делать Поставлена ли машина на учёт?')),
                ('first_name', models.CharField(max_length=30, verbose_name='Имя')),
                ('phone', models.CharField(max_length=30, verbose_name='Телефон')),
                ('created', models.DateTimeField(auto_now_add=True)),
            ],
        ...
        migrations.AlterModelOptions(
            name='callme',
            options={'ordering': ['-created'], 'verbose_name': 'Заявка: перезвоните мне', 'verbose_name_plural': 'Заявки: перезвоните мне'},
        ),
        ...
        migrations.AlterField(
            model_name='car',
            name='year',
            field=models.CharField(blank=True, max_length=4, null=True, verbose_name='Год выпуска'),
        ),
    ]
